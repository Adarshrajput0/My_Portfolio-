      ...
      <div className="about">
        <div className="about-content">
          <p className="text-xl font-bold">
            Hi, I am <strong>Adarsh Kumar</strong>, a{" "}
            <strong>B.Tech Computer Science and Engineering student</strong>{" "}
            with a deep passion for <strong>web development</strong> and{" "}
            <strong>software engineering</strong>. I love creating{" "}
            <strong>user-friendly web applications</strong> using modern
            technologies like <strong>HTML, CSS, JavaScript, React</strong>, and{" "}
            <strong>Tailwind CSS</strong>.
            <br />
            <br />I am constantly <strong>learning and improving</strong> my
            skills in frontend development and core CS concepts like{" "}
            <strong>DSA, Operating Systems</strong>, and{" "}
            <strong>Databases</strong>.
            <br />
            <br />I believe in <strong>deep understanding</strong>, clean code,
            and building <strong>real-world solutions</strong> that create
            impact.
          </p>
        </div>
      </div>
